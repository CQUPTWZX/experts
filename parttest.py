...
if __name__ == '__main__':
    ...
    for t, p in zip(truth, pred):
        ...
        if any(label in labels for label in
               [139, 107, 103, 80, 89, 27, 47, 132, 11, 126, 91, 30, 128, 14, 98, 28, 40, 13, 105, 104, 69, 131, 115,
                100, 31, 17, 136, 114]):
               #[49,45,73,51,17,33,34,9,24,32,85,84,50,59,7,80,35,14,76,68]):
            filtered_truth.append(t)
            filtered_pred.append(p)
    scores = evaluate(filtered_pred, filtered_truth, label_dict)
